...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        view_cube = glm::translate(view_cube, glm::vec3(-0.15f, 0.0f, -5.0f)); // Translate cube back
        view_cube = glm::scale(view_cube, glm::vec3(1.5f, 1.75f, 1.5f)); // Scale down sphere
        ...
        view_cylinder = glm::translate(view_cylinder, glm::vec3(-2.75f, -3.0f, -5.5f)); // Translate cylinder back, to the right, and down
        view_cylinder = glm::scale(view_cylinder, glm::vec3(.8, 3.0, .8)); // Increase height of cylinder
        ...
        view_sphere = glm::translate(view_sphere, glm::vec3(1.7f, 0.3f, -5.0f)); // Translate sphere back and to the left
        view_sphere = glm::scale(view_sphere, glm::vec3(0.82f, 0.82f, 0.82f)); // Scale down sphere
